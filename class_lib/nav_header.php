    <a href="inicio.php" class="logo">
          ...
          <span class="logo-lg"><b>Almacenes</b>Kairos</span>
    </a>
<!-- Header Navbar -->
  <?php
   error_reporting(0);
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="dist/img/fotito.png" class="user-image" alt="User Image">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="dist/img/fotito.png" class="img-circle" alt="User Image">
                    <p>
